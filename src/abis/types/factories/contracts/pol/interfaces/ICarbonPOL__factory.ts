...
import type {
  ICarbonPOL,
  ICarbonPOLInterface,
} from "../../../../contracts/pol/interfaces/ICarbonPOL";
...
export class ICarbonPOL__factory {
  static readonly abi = _abi;
  static createInterface(): ICarbonPOLInterface {
    return new utils.Interface(_abi) as ICarbonPOLInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ICarbonPOL {
    return new Contract(address, _abi, signerOrProvider) as ICarbonPOL;
  }
}
