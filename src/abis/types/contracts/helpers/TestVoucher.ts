...
export interface TestVoucherInterface extends utils.Interface {
  functions: {
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "burn(uint256)": FunctionFragment;
    "burnTest(uint256)": FunctionFragment;
    ...
    "safeMintTest(address,uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "burnTest", data: BytesLike): Result;
...
export interface TestVoucher extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestVoucherInterface;
  ...
  callStatic: {
    ...
    burnTest(tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
